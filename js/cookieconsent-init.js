...
cc.run({
    ...
    cookie_name: 'alleskuehncookies',             // default: 'cc_cookie'
    ...
    languages: {
        'de': {
            consent_modal: {
                ...
                description: 'Hallo Gast, diese Website verwendet essentielle Cookies, um ihren ordnungsgemäßen Betrieb zu gewährleisten, und Tracking-Cookies, um zu verstehen, wie Sie mit ihr interagieren. Letztere werden nur nach Zustimmung gesetzt werden. <button type="button" data-cc="c-settings" class="cc-link">Zur Auswahl</button>',
                primary_btn: {
